                        ...
                        <tbody>
                            @foreach ($submissions as $key => $submission)
                                ...
                                <tr {{ $submission->seen == 0 ? 'style=background-color:#d3d3d35e' : ''  }}>
                                    ...
                                    <td><a href="/{{ app()->getLocale() }}/admin/collaboratesubmission/{{ $submission->id }}" type="button" class="btn btn-info waves-effect width-md waves-light">{{ trans('admin.more') }}</a></td>
